...
　　再生中、右コントロールを押下すると再生終了 (バッチファイルの強制終了) できるようにします。
...
　　例) SndInput.exe RR 10 5 MC 400 300   ... マウスカーソルを (390〜410,295〜305) の何処かに移動する。
...
　ログファイル WRec.log は、およそ 1000 項目書き込む度に自動的に削除されます。
　際限なく大きくなることはありません。
